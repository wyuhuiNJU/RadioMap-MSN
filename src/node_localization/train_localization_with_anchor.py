# /*
#  * @Author: wyuhui 
#  * @Date: 2024-4-19 20:45:32
#  * @Last Modified by:   wyuhui 
#  * @Last Modified time: 2024-4-19 20:45:36
#  */
...
class GNN(nn.Module):
    def __init__(self,params: Params, in_size, out_size) -> None:
        ...
        self.conv1 = dglnn.GraphConv(in_size, N*2) # 升维到N
        ...
        self.conv3 = dglnn.GraphConv(N, N, norm='both', weight=False, bias=False) # 地图矩阵权重层
    ...
    def forward(self, g, features, weight=None, edge_weight=None):
        ...
        x = self.relu(x)
        x = self.conv3(g, x, weight=weight, edge_weight=edge_weight)
        x = self.relu(x)
...
def main():
    ...
    matrix_dir = os.path.join(project_dir, 'topo-2/20/matrix') #!
    point_num = 170 #!
